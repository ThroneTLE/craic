...
LOG_DIR="$HOME/craic/logs/demo_carto"
rm -rf "$LOG_DIR"
mkdir -p "$LOG_DIR"
...
--tab -e "bash -c 'sleep 4; source ~/craic/devel/setup.bash; $RUN_LOG $LOG_DIR 03_navigation roslaunch robot_slam navigation.launch localization:=cartographer; exec bash'" \
