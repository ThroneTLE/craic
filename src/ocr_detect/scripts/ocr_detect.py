...
class ocr:
    ...
    def top_view_shot(self,image_msg):
        ...
        if ocr_det == 1:
            ...
            cv2.imwrite('/home/abot/EIU0US/src/ocr_detect/temp/ocr_now.jpg', self.img_bgr)
            # 将ocr_det重置为255
            ...
            # 调用ocr模型识别
            #ocr_detection()
    def ocr_detection( self,img_path='/home/abot/EIU0US/src/ocr_detect/temp/ocr_now.jpg'):
            global ocr1
            while True:
                if self.is_image_complete('/home/abot/EIU0US/src/ocr_detect/temp/ocr_now.jpg'):
                    break
                else:
                    cv2.imwrite('/home/abot/EIU0US/src/ocr_detect/temp/ocr_now.jpg', self.img_bgr)
