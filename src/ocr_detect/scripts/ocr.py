...
def Draw_OCRResult(blank_img, pt1, pt2, text):
    ...
    #加载中文字体（指定字体路径、大小和编码）
    fontStyle = ImageFont.truetype("/home/abot/EIU0US/src/ocr_detect/ChineseFonts/simsun.ttc", size=21, encoding="utf-8")
...
def ocr_detect():
    ...
    img_path = rospy.get_param('image_path', "/home/abot/EIU0US/src/ocr_detect/image/11.jpg")
    ...
    while not rospy.is_shutdown():
        ...
        save_path = f'/home/abot/EIU0US/src/ocr_detect/result/OCR_result_{file_name}.jpg'
