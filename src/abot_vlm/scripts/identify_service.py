...
def top_view_shot(image_msg):
    ...
    if detect == 1:
        # 保存图像
        save_path = '/home/abot/EIU0US/src/abot_vlm/temp2/vl_now.jpg'
...
def yi_vision_api(
    ...
    PROMPT='图中有一道数学题，请计算题目的最终结果。答案必须是一个两位阿拉伯数字，例如31、33、40、51都有效；不要因为答案是两位数就输出“无”。请先完整解题，最后一行只输出最终答案数字（仅数字，无任何其他字符）。如果最终结果不是以下有效任务编号之一：31、32、33、40、41、42、49、50、51，最后一行才输出“无”。',
    # PROMPT='你看到了色什么',
    img_path='/home/abot/EIU0US/src/abot_vlm/temp2/vl_now.jpg',
