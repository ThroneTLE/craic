...
--tab -e 'bash -c "sleep 4; source ~/EIU0US/devel/setup.bash; roslaunch robot_slam navigation.launch; exec bash"' \
...
--tab -e 'bash -c "sleep 4; source ~/EIU0US/devel/setup.bash; roslaunch robot_slam view_nav.launch; exec bash"' \
--tab -e 'bash -c "sleep 4; source ~/EIU0US/devel/setup.bash; rosrun TTS_audio TTS.py; exec bash"' \
--tab -e 'bash -c "sleep 4; source ~/EIU0US/devel/setup.bash; roslaunch robot_slam GameStart.launch; exec bash"' \
